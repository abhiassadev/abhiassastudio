    ...
    <>
      ...
      <div className="flex flex-col gap-10 sm:grid sm:grid-cols-2">
        <div className="flex flex-col">
          <h1 className="text-md font-medium text-white">Kontak</h1>
          <a
        ...
        <div className="flex flex-col">
          <h1 className="text-md font-medium text-white">Media Sosial</h1>
          <a
        ...
        <div className="flex flex-col">
          <h1 className="text-md font-medium text-white">Pembayaran</h1>
          <a
